<template>
	<div class="container">
		...
		<!--图片第一部分-->
		<div class="bg-top">
			<img src="~assets/images/index11.jpg" alt="" @click="imgClick"/>
		</div>
		<!--图片第二部分-->
		<div class="bg-middle">
			<img src="~assets/images/index13.jpg" alt="" @click="imgClick"/>
		</div>
		<!--测试者的信息-->
		<div class="msg">
			<ul class="msg-list">
				<li class="msg-item" :class="{'msg-item0':!showNameError,'msg-item1':showNameError}" >
					...
					<img src="~assets/images/mandatoryred1.png" alt="" class="mandatory"/>
				</li>
				<li class="msg-item" :class="{'msg-item0':!showSexError,'msg-item1':showSexError}">
					<span>您的性别：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<img v-if="dataObj.gen === 1" src="~assets/images/select1.png" alt="" class="sex" @click="changeSex(1)"/>
					<img v-else src="~assets/images/noSelect1.png" alt="" class="sex" @click="changeSex(1)"/>
					<span class="sexFont">男</span>&nbsp;&nbsp;
					<img v-if="dataObj.gen === 0" src="~assets/images/select1.png" alt="" class="sex" @click="changeSex(0)"/>
					<img v-else src="~assets/images/noSelect1.png" alt="" class="sex" @click="changeSex(0)"/>
					...
					<div class="shadow" v-show="shadow" @click="shadowShow" @touchmove.prevent>
						<div class="shadow-content">
							...
							<ul class="title">
								...
								<li><img src="~assets/images/logo12.png" alt=""/></li>
			...
			<div @click="doAnalysis" class="analysis-box">
				<img src="~assets/images/button1.png" id="btn_jx" alt="" class="analysis"/>
			</div>
		</div>
		<div class="bg-bottom">
			<img src="~assets/images/index15.png" alt="" @click="imgClick"/>
		</div>
	</div>
</template>
...
//					newSpan.src='~assets/images/logo.png)';
				...
				boundary.setAttribute('style', 'color:#ff5181;position:fixed;bottom:44%;left:35%;font-weight:bold;');
				boundary.innerHTML = '|'
				let boundary2 = document.createElement('span')
				boundary2.setAttribute('style', 'color:#ff5181;position:fixed;bottom:44%;right:35%;font-weight:bold;');
				boundary2.innerHTML = '|'
...
//				this.shadow = false
			...
			doAnalysis() {
				...
				//添加友盟统计数据
//				console.log("测试"+this.dataObj.dt.substr(0,4));
//                console.log("测试"+this.province);
				window._czc.push(["_trackEvent", "命中人", "性别", this.sex ? '男' : '女', '1']);
				window._czc.push(["_trackEvent", "命中人", "出生日期", this.dataObj.dt.substr(0,4), '1']);
				window._czc.push(["_trackEvent", "命中人", "出生地点", this.province, '1']);
				window._czc.push(["_trackEvent", "命中人", "立即解析点击", "立即解析点击", '1']);
				//判断信息为空的情况
