<template>
	<div class="container" :style="styleObject">
		...
		<div class="effect-wrap">
			...
			<img src="~assets/images/effect.png" alt="" class="effect"/>
			<img src="~assets/images/light.png" alt="" class="light animated zoomIn infinite"/>
		</div>
...
//						document.getElementsByClassName('progress')[0].style.width = 90 + '%'
//					}
                    this.i1=false;
                    this.i2=false;
                    this.i3=false;
